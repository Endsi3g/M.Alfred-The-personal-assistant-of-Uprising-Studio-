...
SYSTEM_NAME = "A.L.F.R.E.D"
MODEL_BADGE = "PROJECT W.A.Y.N.E"

C_BG     = "#02060a"  # Batman Dark Blue/Black
C_PRI    = "#ffcc00"  # Batman Gold
C_MID    = "#00d4ff"  # Tactical Cyan
C_DIM    = "#0a1219"  # Slate Grey
C_DIMMER = "#050a0f"
C_ACC    = "#ff6600"
C_ACC2   = "#ffcc00"
C_TEXT   = "#e0e0e0"
